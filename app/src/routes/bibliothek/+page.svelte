      ...
      <div class="space-y-4">
        {#each groups as [normalizedTitle, items] (normalizedTitle)}
          ...
          <details class="bg-surface-container-highest rounded-xl overflow-hidden">
            <summary class="p-6 flex items-center justify-between cursor-pointer select-none list-none">
              <div>
            ...
            <div class="px-6 pb-6 space-y-4">
              {#each items as {song, student} (song._id)}
                <a
                  ...
                  class="bg-surface-container-low p-4 rounded-xl flex items-center justify-between active:scale-[0.98] transition-transform"
                >
